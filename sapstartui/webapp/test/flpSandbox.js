					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sap start card",
									"targetURL": "#sapstartui-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"sapstartui-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapstartui",
									"url": sap.ui.require.toUrl("sapstartui")
								}
							}
						}
					}
